 ...
 */
package com.appsdeveloperblog.ws.client.photoappwebclients.response;
...
public class AlbumRest {
	...
	public String toString() {
		return "AlbumRest [userId=" + userId + ", albumId=" + albumId + ", albumTitle=" + albumTitle
				+ ", albumDescription=" + albumDescription + ", albumUrl=" + albumUrl + "]";
	}
